...
const DISCORD_CLIENT_ID = '1468563080333099116';
...
function IdentityNode({ data }) {
  ...
  const isLoggedIn = !!data.discordAvatar;
  ...
  return (
    <div className="node-container">
      ...
      <div className="node-content identity-info">
        ...
        {!isLoggedIn ? (
          <button className="discord-login-btn" onClick={handleLogin} disabled={isLoading}>
            {isLoading ? (
              'Authenticating...'
            ) : (
              <>
          ...
          <button className="discord-logout-btn" onClick={handleLogout}>
            Disconnect
          </button>
        )}
      </div>
